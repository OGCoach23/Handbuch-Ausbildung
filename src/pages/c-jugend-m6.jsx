...
const cardsData = [
  ...
  {
    title: "Besonderheiten in der C-Jugend",
    content: [
      "Gruppenzugehörigkeit extrem wichtig – oft wichtiger als die individuelle Rolle.",
      "Konflikte & Cliquen entstehen häufiger, sind aber bearbeitbar.",
  ...
  {
    title: "Elternarbeit in der C-Jugend",
    content: [
        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
            ...
            <p className="text-center text-xl text-green-700 italic leading-relaxed">
              "Aus Mitspielern ein echtes Team entwickeln"
            </p>
          </div>
        </motion.div>
