  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="bg-green-100/40 backdrop-blur-md border border-green-200 p-6 rounded-2xl shadow-lg max-w-4xl mx-auto mt-8"
      >
        <p className="text-lg">
      ...
      {/* Grauer → Blauer Textabschnitt */}
      <motion.div
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: false }}
        transition={{ duration: 0.6 }}
        className={`mt-8 max-w-5xl mx-auto space-y-4 ${textColor} transition-colors duration-500`}
      >
        <p>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="bg-green-100/40 backdrop-blur-md border border-green-200 p-6 rounded-2xl shadow-lg max-w-4xl mx-auto mt-8 mb-20"
      >
        <h2 className="text-xl font-bold mb-2">Gesamtfazit</h2>
        <p className="mb-4">Dieses Konzept ist ehrlich. Es wächst mit jedem, der es lebt.</p>
        <p>
