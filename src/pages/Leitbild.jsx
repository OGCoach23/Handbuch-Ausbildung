...
export default function Leitbild() {
  return (
    ...
    >
      ...
      <p>
        Unser Ausbildungskonzept verfolgt eine klare Vision: Handball ist mehr als ein Spiel – er ist eine Schule fürs
        Leben. Wir wollen Kinder und Jugendliche ganzheitlich fördern: sportlich, persönlich, sozial und mental.
      </p>

      <p>
        Dabei geht es uns nicht nur um Talente oder Siege, sondern darum, Menschen zu entwickeln, die mit Teamgeist,
        Fairness und Selbstvertrauen durchs Leben gehen. Denn nur wer sich als Mensch entfaltet, kann auch als
        Spieler:in wachsen.
      </p>

      <p>
        Handball ist eine intensive Mannschaftssportart, nur im Team kann man gewinnen, nur gemeinsam lernt man aus
        Niederlagen. Handball ist körperlich, aber immer fair. HandballerInnen sind sportlich, engagiert, fröhlich und
        lebensfroh.
      </p>

      <p>Wir glauben: Gute Ausbildung beginnt mit guter Haltung.</p>
      ...
      <p>
        ...
        ständig mit anderen zu messen. Positiver Wettbewerb und kein neidvoller Vergleich!
      </p>
      ...
      <p>
        ...
        weiterentwickeln – vom ersten Kontakt mit dem Ball bis hin zur Vorbereitung auf den Erwachsenenbereich. Jeder
        Schritt ist abgestimmt auf die Bedürfnisse der Altersstufe – aber lässt Spielraum für eigene Wege.
      </p>

      <p>Wir vermitteln eine Haltung:</p>
      ...
      <p className="font-semibold">Unsere Ziele:</p>
      <p>Am Ende der Jugendzeit soll jede:r Spieler:in …</p>
      <ul className="list-disc list-inside space-y-1">
      ...
      <p>
        Du bist nicht nur Übungsleiter – du bist Wegbegleiter. Du gestaltest Erfahrungsräume. Dein Ziel: nicht
        Spieler:innen „fertig machen", sondern sie fähig machen, ihre Stärken zu erkennen, Entscheidungen zu treffen und
        mit Druck umzugehen. Das geht weit über das Sportliche hinaus.
      </p>

      <p className="font-semibold">Elternblick:</p>
      <p>
        Wir wollen mehr als Punkte oder Tabellen – wir wollen, dass Ihr Kind stark wird: im Kopf, im Herz, im Spiel.
        Handball ist für uns eine Bühne, auf der Kinder wachsen – nicht nur als Spieler:innen, sondern als Menschen.
      </p>

      <p className="font-semibold">Für Spieler:innen – kurz erklärt:</p>
      <p>
        Hier geht's nicht nur ums Gewinnen. Es geht darum, dass du deinen Weg findest. Du lernst, was du kannst, wie du
        denkst – und dass du mehr schaffen kannst, als du glaubst. Dass du ein Team hast, dass du Ansprechpartner kennen
