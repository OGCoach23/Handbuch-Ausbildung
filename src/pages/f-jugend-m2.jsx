  ...
  return (
    <div className="bg-green-50 min-h-screen p-6">
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-primary mb-6">M2: Athletik & Motorik</h1>
        <p className="text-lg mb-8 italic">
          Bewegungskompetenz als Fundament: kindgerecht, vielseitig, handballspezifisch.
        </p>
        ...
        <div className="bg-white/60 backdrop-blur-md p-6 rounded-xl shadow">
          ...
          <p className="text-gray-700">
            Dieses Modul wird noch mit detaillierten Inhalten zur Athletik und Motorik für die F-Jugend gefüllt.
          </p>
        </div>
      </motion.div>
    </div>
